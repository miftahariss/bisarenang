...
<table class="table table-hover table-condensed">
    <tbody class="alert alert-info">
    	<tr>
	        <a href="<?php echo base_url()?>backend/acladmin/add_blog/" class="btn tambah_artikel"><span class="icon-plus-sign"></span> Tambah Safety Swim</a>
...
<!--                        <li><a href="#<?php //echo base_url()?>" target="_blank"><span class="icon-list-alt"></span> Detail</a></li>-->
                        <li><a href="<?php echo base_url()?>backend/acladmin/edit_safety/<?php echo $r->id ?>"><span class="icon-edit"></span> Edit</a></li>
                        <li><a href="<?php echo base_url()?>backend/acladmin/delete_safety/<?php echo $r->id ?>" onclick="return confirm('Yakin data ini ingin dihapus?')"><span class="icon-remove-sign"></span> Delete</a></li>
                    </ul>
                </div>
            </td>
        </tr>
