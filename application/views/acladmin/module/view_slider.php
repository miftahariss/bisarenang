...
<table class="table table-hover table-condensed">
    <tbody class="alert alert-info">
        <tr>
            <a href="<?php echo base_url()?>backend/acladmin/add_slider/" class="btn tambah_artikel"><span class="icon-plus-sign"></span> Tambah Slider</a>
            <?php $attributes = array('class'=>'navbar-form pull-left'); ?>
            <!--<?php echo form_open('backend/acladmin/search_profil', $attributes); ?>
...
<!--                        <li><a href="#<?php //echo base_url()?>" target="_blank"><span class="icon-list-alt"></span> Detail</a></li>-->
                        <li><a href="<?php echo base_url()?>backend/acladmin/edit_slider/<?php echo $r->id ?>"><span class="icon-edit"></span> Edit</a></li>
                        <li><a href="<?php echo base_url()?>backend/acladmin/delete_slider/<?php echo $r->id ?>" onclick="return confirm('Yakin data ini ingin dihapus?')"><span class="icon-remove-sign"></span> Delete</a></li>
                    </ul>
                </div>
            </td>
        </tr>
