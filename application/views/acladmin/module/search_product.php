...
<table class="table table-hover table-condensed">
    <tbody class="alert alert-info">
    	<tr>
	        <a href="<?php echo base_url()?>admin/acladmin/add_media/" class="btn"><span class="icon-plus-sign"></span> Tambah Artikel</a>
...
<!--                        <li><a href="#<?php //echo base_url()?>" target="_blank"><span class="icon-list-alt"></span> Detail</a></li>-->
                        <li><a href="<?php echo base_url()?>admin/acladmin/edit_media/<?php echo $r['id'] ?>"><span class="icon-edit"></span> Edit</a></li>
                        <li><a href="<?php echo base_url()?>admin/acladmin/delete_media/<?php echo $r['id'] ?>" onclick="return confirm('Yakin data ini ingin dihapus?')"><span class="icon-remove-sign"></span> Delete</a></li>
                    </ul>
                </div>
            </td>
        </tr>
