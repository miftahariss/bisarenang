    ...
    <table class="table table-striped" id="editPhoto">
        ...
        <?php foreach ($photos as $photo): ?>
            <tr>
                ...
                <td>
                    <?php echo anchor('/admin/acladmin/edit_product_gallery_foto/' . $article->id . '/' . $photo->id, "<span class='icon-edit'></span> Edit",array('class'=>'btn','onclick'=>"return confirm('yakin mau edit photo ini?')"));?>
                    <?php echo anchor('/admin/acladmin/delete_product_gallery_foto/' . $article->id . '/' . $photo->id, "<span class='icon-remove-sign'></span> Delete",array('class'=>'btn','onclick'=>"return confirm('yakin mau delete photo ini?')"));?>
                </td>
            </tr>
